    ...
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w-[500px]'>
          Create imaginative and visually stunning images through by DALL-E AI and share with community
        </p>
      </div>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
          ...
          rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center'>
            {form.photo ? (
              <img
                src={form.photo}
                alt={form.prompt}
                className='w-full h-ull object-contain'
              />
            ) : (
              <img
                src={preview}
        ...
        <div className='mt-10'>
          <p className='mt-2 text-[#666e75] text-[14px]'>Once you have created the image you can share</p>
          <button
            type='submit'
